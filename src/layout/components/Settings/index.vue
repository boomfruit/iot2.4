  ...
  <el-drawer size="280px" :visible="visible" :with-header="false" :append-to-body="true" :show-close="false">
    <div class="drawer-container">
      <div>
        ...
        <el-button size="small" type="primary" plain icon="el-icon-document-add"
          @click="saveSetting">{{ $t('layout.components.settings.index.909453-8') }}</el-button>
        <el-button size="small" plain icon="el-icon-refresh"
          @click="resetSetting">{{ $t('layout.components.settings.index.909453-9') }}</el-button>
      </div>
    </div>
  </el-drawer>
</template>
