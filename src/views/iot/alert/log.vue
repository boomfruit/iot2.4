        ...
        <el-card v-show="showSearch" style="margin-bottom: 6px">
            <!-- <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px" style="margin-bottom: -20px">
                ...
                <el-form-item :label="$t('alert.log.491272-4')" prop="status">
                    <el-select v-model="queryParams.status" :placeholder="$t('alert.log.491272-5')" clearable size="small">
            ...
            <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
                <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                    <el-form-item :label="$t('alert.log.491272-26')" prop="remark">
                        <el-input v-model="form.remark" type="textarea" :placeholder="$t('notify.log.333543-18')" rows="8" />
                    </el-form-item>
                </el-form>
