        ...
        <el-card v-show="showSearch" style="margin-bottom: 6px">
            <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px"
                ...
                <el-form-item :label="$t('alert.index.236501-0')" prop="alertName">
                    <el-input v-model="queryParams.alertName" :placeholder="$t('alert.log.491272-1')" clearable
                ...
                <el-form-item :label="$t('alert.log.491272-4')" prop="status">
                ...
                <el-table-column :label="$t('opation')" align="center" width="100">
                    <template slot-scope="scope">
                        <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                            v-hasPermi="['iot:alertLog:edit']">{{ $t('alert.log.491272-25') }}</el-button>
                    </template>
                </el-table-column>
            </el-table>
            ...
            <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
                <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                    <el-form-item :label="$t('alert.log.491272-26')" prop="remark">
                        <el-input v-model="form.remark" type="textarea" :placeholder="$t('notify.log.333543-18')"
                            rows="8" />
                    </el-form-item>
                </el-form>
...
export default {
        ...
        return {
            ...
            rules: {
                remark: [
                    {
                        required: true,
                        message: this.$t('alert.log.491272-18'),
                        trigger: 'blur',
                    },
                ],
            },
    ...
    methods: {
        ...
        handleAdd() {
            this.reset();
            this.open = true;
            this.title = this.$t('alert.log.491272-19');
        },
        /** 修改按钮操作 */
        handleUpdate(row) {
            this.reset();
            ...
            getAlertLog(alertLogId).then((response) => {
                ...
                this.open = true;
                this.title = this.$t('alert.log.491272-20');
            });
        },
        /** 提交按钮 */
        submitForm() {
        ...
        handleDelete(row) {
            ...
            this.$modal
                .confirm(this.$t('alert.log.491272-23', [alertLogIds]))
                .then(function () {
