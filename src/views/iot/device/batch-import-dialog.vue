<template>
    <!-- 批量导入设备 -->
    <el-dialog :modal="false" :title="upload.title" :visible.sync="upload.importDeviceDialog" width="550px" append-to-body>
        <div style="margin-top: -55px">
            ...
            <el-form label-position="top" :model="importForm" ref="importForm" :rules="importRules">
                ...
                <el-form-item :label="$t('uploadFile')" prop="fileList">
                    ...
                    <el-link type="primary" :underline="false" style="font-size: 14px; vertical-align: baseline" @click="importTemplate">
...
export default {
    ...
    methods: {
        /** 下载模板操作 */
        importTemplate() {
            this.download('/iot/device/uploadTemplate?type=' + this.type, {}, `device_template_${new Date().getTime()}.xlsx`);
        },
