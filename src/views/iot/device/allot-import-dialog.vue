    ...
    <div style="margin-top: -55px">
      ...
      <el-form label-position="top" :model="allotForm" ref="allotForm" :rules="allotRules">
        ...
        <el-form-item :label="$t('uploadFile')" prop="fileList">
          ...
          </el-upload> <el-link type="primary" :underline="false"
                                style="font-size:14px;vertical-align: baseline;" @click="importAllotTemplate"><i
          class="el-icon-download"></i>{{ $t('device.allot-import-dialog.060657-10') }}</el-link>
        </el-form-item>
      </el-form>
    </div>
