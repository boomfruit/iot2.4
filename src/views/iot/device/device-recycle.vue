          ...
          <div style="width: 35%;">
            <el-form-item :label="$t('device.device-recycle.864193-1')" prop="deptId">
              <treeselect v-model="queryParams.deptId" :options="deptOptions" :show-count="true"
                :placeholder="$t('device.device-recycle.864193-2')" @input="getList" />
            </el-form-item>
          </div>
        </el-form>
      </div>
          ...
          <el-form ref="queryForm" :model="queryParams">
            <el-col :span="7">
              <el-form-item prop="productId">
                <el-select v-model="queryParams.productId" :placeholder="$t('device.allot-import-dialog.060657-1')"
                  style="width: 95%" clearable filterable>
            ...
            <el-col :span="7">
              <el-form-item prop="deviceName">
                <el-input :placeholder="$t('device.device-edit.148398-2')" clearable v-model="queryParams.deviceName"
                  style="width: 95%">
                </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="1.5">
              <el-button type="primary" icon="el-icon-search" @click="handleQuery">{{
                $t('device.device-recycle.864193-5') }}
              </el-button>
            </el-col>
            <el-button icon="el-icon-refresh-left" @click="resetQuery" style="margin-left: 5px;">{{
              $t('device.device-recycle.864193-6') }}</el-button>
          </el-form>
        </el-row>
      </div>
      <div class="general">
        <div class="topLeft">
          ...
          <el-row>
            <el-table ref="leftTableData" :data="menuTableData" style="width: 100%" max-height="373"
              ...
              <el-table-column prop="productName" :label="$t('device.allot-record.155854-2')" show-overflow-tooltip>
              </el-table-column>
              <el-table-column prop="serialNumber" :label="$t('device.device-edit.148398-7')" show-overflow-tooltip>
              </el-table-column>
              <el-table-column prop="deviceName" :label="$t('device.device-edit.148398-1')" show-overflow-tooltip>
              </el-table-column>
            </el-table>
          </el-row>
        </div>
        ...
        <div class="topRight">
          ...
          <el-row>
            <el-table ref="rightTableData" :data="rightTableData" style="width: 100%" max-height="373"
