<template>
    <el-dialog :title="$t('device.product-list.058448-0')" :modal="false" :visible.sync="open" width="800px">
        <div style="margin-top: -55px">
            ...
            <el-table v-loading="loading" ref="singleTable" :data="productList" @row-click="rowClick" size="mini">
