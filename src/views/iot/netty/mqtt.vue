              ...
              <div class="card-panel">
                ...
                <div class="card-panel-description">
                  <div>
                    ...
                    <count-to :start-val="0" :end-val="this.static['send_total']" :duration="3000"
              ...
              <div class="card-panel">
                ...
                <div class="card-panel-description">
                  <div>
                    ...
                    <count-to :start-val="0" :end-val="this.static['receive_total']" :duration="3000"
                      class="card-panel-num" />
                  </div>
                </div>
              </div>
            ...
            <el-col :span="24" class="card-panel-col" style="margin-bottom: 17px">
              <div class="card-panel">
                ...
                <div class="card-panel-description">
                  ...
                  <count-to :start-val="0" :end-val="this.static['auth_total']" :duration="1000"
                    class="card-panel-num" />
                </div>
              </div>
            </el-col>
            <el-col :span="24" class="card-panel-col" style="margin-bottom: 18px">
              <div class="card-panel">
                ...
                <div class="card-panel-description">
                  ...
                  <count-to :start-val="0" :end-val="this.static['connect_total']" :duration="1000"
                    class="card-panel-num" />
                </div>
              </div>
            </el-col>
            <el-col :span="24" class="card-panel-col" style="margin-bottom: 17px">
              <div class="card-panel">
                ...
                <div class="card-panel-description">
                  ...
                  <count-to :start-val="0" :end-val="this.static['subscribe_total']" :duration="2000"
                    class="card-panel-num" />
                </div>
              </div>
            </el-col>
              ...
              <div class="card-panel">
                ...
                <div class="card-panel-description">
                  <div>
                    ...
                    <count-to :start-val="0" :end-val="this.static['today_received']" :duration="3000"
                      class="card-panel-num" />
                  </div>
                </div>
              </div>
            ...
            <el-col :span="24" class="card-panel-col" style="margin-bottom: 17px">
              <div class="card-panel">
                ...
                <div class="card-panel-description">
                  ...
                  <count-to :start-val="0" :end-val="this.static['today_send']" :duration="2000"
                    class="card-panel-num" />
                </div>
              </div>
            </el-col>
