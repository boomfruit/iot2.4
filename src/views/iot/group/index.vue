    ...
    <div style="padding: 6px">
        <el-card v-show="showSearch" style="margin-bottom: 6px">
            <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px" style="margin-bottom: -20px">
                ...
                <el-form-item style="float: right">
                    <el-button v-hasPermi="['iot:group:add']" type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd">{{ $t('iot.group.index.637432-5') }}</el-button>
                </el-form-item>
            </el-form>
        </el-card>
        ...
        <el-card style="padding-bottom: 100px">
            <el-table v-loading="loading" :data="groupList" border @selection-change="handleSelectionChange">
                ...
                <el-table-column :label="$t('iot.group.index.637432-10')" align="center" class-name="small-padding fixed-width" width="420">
                    <template slot-scope="scope">
                        <el-button v-hasPermi="['iot:device:list']" size="small" type="warning" style="padding: 5px" icon="el-icon-search" @click="handleViewDevice(scope.row.groupId)">
            ...
            <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
                ...
                <div slot="footer" class="dialog-footer">
                    <el-button type="primary" @click="submitForm" v-show="form.groupId" v-hasPermi="['iot:group:edit']">{{ $t('iot.group.index.637432-17') }}</el-button>
                    <el-button type="primary" @click="submitForm" v-hasPermi="['iot:group:add']" v-show="!form.groupId">{{ $t('iot.group.index.637432-18') }}</el-button>
