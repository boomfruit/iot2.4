<template>
    <el-dialog :title="$t('iot.group.device-list.849593-0')" :visible.sync="openDeviceList" width="800px"
        append-to-body>
        <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
            <el-form-item :label="$t('iot.group.device-list.849593-1')" prop="deviceName">
                <el-input v-model="queryParams.deviceName" :placeholder="$t('iot.group.device-list.849593-2')" clearable
                    size="small" @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item>
                <el-button type="primary" icon="el-icon-search" size="mini"
                    @click="handleQuery">{{ $t('iot.group.device-list.849593-3') }}</el-button>
            </el-form-item>
        </el-form>
        ...
        <div slot="footer" class="dialog-footer">
            <el-button type="primary"
                @click="handleDeviceSelected">{{ $t('iot.group.device-list.849593-11') }}</el-button>
