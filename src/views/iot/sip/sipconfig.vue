            ...
            <el-row :gutter="100">
                ...
                <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="8">
                    <el-form-item :label="$t('sip.sipConfig.998537-5')">
                        <el-input v-model="accessWay" disabled></el-input>
                    </el-form-item>
                ...
                <el-col :xs="23" :sm="23" :md="23" :lg="23" :xl="15">
                    <el-form-item style="text-align: center; margin-top: 20px">
                        <el-button v-show="form.id && productInfo.status != 2" v-hasPermi="['iot:video:edit']" type="primary" @click="submitForm">{{ $t('update') }}</el-button>
                        <el-button v-show="!form.id && productInfo.status != 2" v-hasPermi="['iot:video:add']" type="primary" @click="submitForm">{{ $t('add') }}</el-button>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
