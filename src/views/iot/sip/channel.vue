<template>
    <div style="padding-left: 20px">
        ...
        <el-table v-loading="loading" :data="channelList" size="mini">
            <el-table-column :label="$t('sip.channel.998532-0')" align="center" prop="deviceSipId" min-width="110" />
            <el-table-column :label="$t('sip.channel.998532-1')" align="center" prop="channelSipId" min-width="110" />
