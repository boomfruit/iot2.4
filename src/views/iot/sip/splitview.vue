            ...
            <el-container v-loading="loading" style="height: 91vh" :element-loading-text="$t('sip.splitview.998531-0')">
                ...
                <el-main style="padding: 0">
                    <div height="5vh" style="text-align: left; font-size: 17px; line-height: 5vh; margin-bottom: 10px">
                        ...
                        <el-button type="success" style="margin-left: 10px" :class="{ active: spilt == 1 }" @click="spilt = 1" plain icon="el-icon-full-screen" size="mini">{{ $t('sip.splitview.998531-2') }}</el-button>
                        ...
                        <el-button type="warning" style="margin-left: 10px" :class="{ active: spilt == 9 }" @click="spilt = 9" plain icon="el-icon-s-grid" size="mini">{{ $t('sip.splitview.998531-4') }}</el-button>
                    </div>
                    <div style="height: 85vh; display: flex; flex-wrap: wrap">
                        <div v-for="i in spilt" :key="i" class="play-box" :style="liveStyle" :class="{ redborder: playerIdx == i - 1 }" @click="playerIdx = i - 1">
                            ...
                            <player ref="player" v-else :videoUrl="videoUrl[i - 1]" fluent autoplay @screenshot="shot" @destroy="destroy" class="player-wrap" />
                        </div>
                    </div>
                </el-main>
            </el-container>
