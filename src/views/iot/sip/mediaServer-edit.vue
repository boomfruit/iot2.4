                ...
                <el-form v-if="currentStep == 1" ref="mediaServerForm" :rules="rules" :model="mediaServerForm" label-width="280px" style="width: 70%">
                    ...
                    <el-form-item>
                        <div style="float: right; font-size: 28px">
                            ...
                            <el-button type="success" @click="checkServer" :loading="btnLoading">{{ $t('notify.template.index.333542-7') }}</el-button>
                    ...
                    <el-col :span="12">
                        <el-form v-if="currentStep === 2 || currentStep === 3" ref="mediaServerForm1" :rules="rules" :model="mediaServerForm" label-width="140px" :disabled="!editFlag">
                            <el-form-item :label="$t('sip.mediaServerEdit.998534-7')" prop="serverId">
                                <el-input v-model="mediaServerForm.serverId" :placeholder="$t('sip.mediaServerEdit.998534-7')" clearable></el-input>
                            </el-form-item>
                            ...
                            <el-form-item :label="$t('sip.mediaServerEdit.998534-12')" prop="portRtsp">
                                <el-input v-model="mediaServerForm.portRtsp" :placeholder="$t('sip.mediaServerEdit.998534-12')" clearable></el-input>
                            </el-form-item>
                        </el-form>
                    </el-col>
                    <el-col :span="12">
                        <el-form v-if="currentStep === 2 || currentStep === 3" ref="mediaServerForm2" :rules="rules" :model="mediaServerForm" label-width="180px" :disabled="!editFlag">
                            ...
                            <el-form-item :label="$t('sip.mediaServerEdit.998534-14')" prop="domain">
                                <el-input v-model="mediaServerForm.domain" :placeholder="$t('sip.mediaServerEdit.998534-14')" clearable></el-input>
                            </el-form-item>
                            ...
                            <el-form-item :label="$t('sip.mediaServerEdit.998534-16')">
                                <el-switch
                                    :active-text="$t('sip.mediaServerEdit.998534-17')"
                                    :inactive-text="$t('sip.mediaServerEdit.998534-18')"
                                    @change="portRangeChange"
                                    v-model="mediaServerForm.rtpEnable"
                                ></el-switch>
                            </el-form-item>
                            <el-form-item v-if="!mediaServerForm.rtpEnable" :label="$t('sip.mediaServerEdit.998534-19')" prop="rtpProxyPort">
                            ...
                            <el-form-item v-if="mediaServerForm.rtpEnable" :label="$t('sip.mediaServerEdit.998534-19')">
                                <el-input v-model="rtpPortRange1" :placeholder="$t('sip.mediaServerEdit.998534-20')" @change="portRangeChange" clearable style="width: 100px" prop="rtpPortRange1"></el-input>
                                <el-input v-model="rtpPortRange2" :placeholder="$t('sip.mediaServerEdit.998534-21')" @change="portRangeChange" clearable style="width: 100px" prop="rtpPortRange2"></el-input>
                            </el-form-item>
                            <el-form-item :label="$t('sip.mediaServerEdit.998534-22')" prop="portRtmp">
                                <el-input v-model="mediaServerForm.portRtmp" :placeholder="$t('sip.mediaServerEdit.998534-22')" clearable></el-input>
                            </el-form-item>
