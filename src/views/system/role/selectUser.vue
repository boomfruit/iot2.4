<template>
  <!-- 授权用户 -->
  <el-dialog :title="$t('role.selectUser.093468-0')" :visible.sync="visible" width="800px" top="5vh" append-to-body>
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true">
      ...
      <el-form-item :label="$t('user.index.098976-13')" prop="phonenumber">
        <el-input v-model="queryParams.phonenumber" :placeholder="$t('user.index.098976-18')" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-row>
      <el-table @row-click="clickRow" ref="table" :data="userList" @selection-change="handleSelectionChange"
        ...
        <el-table-column :label="$t('user.index.098976-13')" prop="phonenumber" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    handleSelectUser() {
      ...
      if (userIds == "") {
        this.$modal.msgError(this.$t('role.selectUser.093468-'));
        return;
      }
