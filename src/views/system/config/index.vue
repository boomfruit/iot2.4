<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="danger" plain icon="el-icon-refresh" size="mini" @click="handleRefreshCache" v-hasPermi="['	system:config:refresh']">{{ $t('system.dict.index.880996-5') }}</el-button>
            </el-col>
        ...
        <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
            ...
            <el-table-column :label="$t('system.config.898564-6')" align="center" prop="configValue" />
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item :label="$t('system.config.898564-6')" prop="configValue">
                    <el-input v-model="form.configValue" :placeholder="$t('system.config.898564-7')" />
                </el-form-item>
                <el-form-item :label="$t('system.config.898564-4')" prop="configType">
