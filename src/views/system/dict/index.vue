<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate" v-hasPermi="['system:dict:edit']">{{ $t('update') }}</el-button>
            </el-col>
            <el-col :span="1.5">
            ...
            <el-col :span="1.5">
                <el-button type="danger" plain icon="el-icon-refresh" size="mini" @click="handleRefreshCache" v-hasPermi="['system:dict:refresh']">{{ $t('system.dict.index.880996-5') }}</el-button>
            </el-col>
        ...
        <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column :label="$t('system.dict.data.879098-0')" align="center" prop="dictName" :show-overflow-tooltip="true" />
            <el-table-column :label="$t('system.dict.data.879098-8')" align="center" :show-overflow-tooltip="true">
            ...
            <el-table-column :label="$t('opation')" align="center" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:dict:edit']">{{ $t('update') }}</el-button>
...
export default {
    ...
    methods: {
        ...
        handleRefreshCache() {
            refreshCache().then(() => {
                this.$modal.msgSuccess(this.$t('system.dict.index.880996-12'));
