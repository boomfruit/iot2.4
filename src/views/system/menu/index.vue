                    ...
                    <el-row>
                        <el-col :span="24">
                            <el-form-item :label="$t('system.menu.034890-7')" prop="parentId">
                                <treeselect v-model="form.parentId" :options="menuOptions" :normalizer="normalizer" :show-count="true" :placeholder="$t('system.menu.034890-8')" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="24">
                            <el-form-item :label="$t('system.menu.034890-9')" prop="menuType">
                                <el-radio-group v-model="form.menuType">
                                    <el-radio label="M">{{ $t('system.menu.034890-10') }}</el-radio>
                                    <el-radio label="C">{{ $t('system.menu.034890-11') }}</el-radio>
                                    <el-radio label="F">{{ $t('system.menu.034890-12') }}</el-radio>
                                </el-radio-group>
                            </el-form-item>
                        </el-col>
                        <el-col :span="24" v-if="form.menuType != 'F'">
                            <el-form-item :label="$t('system.menu.034890-13')" prop="icon">
                                <el-popover placement="bottom-start" width="460" trigger="click" @show="$refs['iconSelect'].reset()">
                                    ...
                                    <el-input slot="reference" v-model="form.icon" :placeholder="$t('system.menu.034890-14')" readonly>
                        ...
                        <el-col :span="12" v-if="form.menuType != 'F'">
                            <el-form-item prop="isFrame">
                                ...
                                <el-radio-group v-model="form.isFrame">
                                    <el-radio label="0">{{ $t('scene.index.670805-1') }}</el-radio>
                                    <el-radio label="1">{{ $t('scene.index.670805-2') }}</el-radio>
                                </el-radio-group>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12" v-if="form.menuType != 'F'">
