<template>
    <div class="app-container">
        ...
        <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
            ...
            <el-table-column :label="$t('operlog.874509-0')" align="center" prop="title" />
            <el-table-column :label="$t('operlog.874509-4')" align="center" prop="businessType">
                <template slot-scope="scope">
                    <dict-tag :options="dict.type.sys_oper_type" :value="scope.row.businessType" />
                </template>
            </el-table-column>
            <el-table-column :label="$t('operlog.874509-9')" align="center" prop="requestMethod" />
            <el-table-column :label="$t('operlog.874509-2')" align="center" prop="operName" width="100" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']" />
            ...
            <el-table-column :label="$t('operlog.874509-5')" align="center" prop="status">
                <template slot-scope="scope">
                    <dict-tag :options="dict.type.sys_common_status" :value="scope.row.status" />
                </template>
            </el-table-column>
            <el-table-column :label="$t('operlog.874509-12')" align="center" prop="operTime" sortable="custom" :sort-orders="['descending', 'ascending']" width="180">
                <template slot-scope="scope">
        ...
        <!-- 操作日志详细 -->
        <el-dialog :title="$t('operlog.874509-14')" :visible.sync="open" width="700px" append-to-body>
