<template>
    <div class="shack-box">
        ...
        <div class="shack-item-box">
            <div v-for="item in shackListData" :key="item.name" :class="[currentHoverId === item.id ? 'shack-item-hover' : '']" class="shack-item" @mouseover="handleMouseOver(item)" @mouseleave="handleMouseLeave(item)">
