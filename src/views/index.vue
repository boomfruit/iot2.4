    ...
    <div style="padding: 10px; background-color: #f8f8f8">
        <el-row :gutter="20" style="margin: 10px 0px 20px 0px">
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="10" :xl="10">
                <el-card shadow="none" style="height: 334px">
                    ...
                    <el-row :gutter="40" class="panel-group">
                        <el-col :span="12" class="card-panel-col">
                            <div class="card-panel">
                                ...
                                <div class="card-panel-description">
                                    <div class="card-panel-text">{{ $t('home.number') }}</div>
                        ...
                        <el-col :span="12" class="card-panel-col">
                            <div class="card-panel">
                                ...
                                <div class="card-panel-description">
                                    <div class="card-panel-text">{{ $t('home.monitoring') }}</div>
                        ...
                        <el-col :span="12" class="card-panel-col">
                            <div class="card-panel">
                                ...
                                <div class="card-panel-description">
                                    <div class="card-panel-text">{{ $t('home.product') }}</div>
                        ...
                        <el-col :span="12" class="card-panel-col">
                            <div class="card-panel">
                                ...
                                <div class="card-panel-description">
                                    <div class="card-panel-text">{{ $t('home.alarm') }}</div>
                        ...
                        <el-col :span="12" class="card-panel-col">
                            <div class="card-panel">
                                ...
                                <div class="card-panel-description">
                                    <div class="card-panel-text">{{ $t('home.records') }}</div>
                        ...
                        <el-col :span="12" class="card-panel-col">
                            <div class="card-panel">
                                ...
                                <div class="card-panel-description">
                                    <div class="card-panel-text">{{ $t('home.reports') }}</div>
                ...
                <el-card shadow="none" style="margin-top: 22px; height: 296px">
