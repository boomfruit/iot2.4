<template>
  <div>
    ...
    <div class="popup-main">
      ...
      <div class="pop_btn">
        <el-button size="small" type="primary" @click="submitFill">{{ $t('components.Crontab.index.464657-9')
          }}</el-button>
        <el-button size="small" type="warning" @click="clearCron">{{ $t('components.Crontab.index.464657-10')
          }}</el-button>
...
export default {
  data() {
    return {
      tabTitles: [this.$t('components.Crontab.index.464657-0'), this.$t('components.Crontab.index.464657-1'), this.$t('components.Crontab.index.464657-2'), this.$t('components.Crontab.index.464657-3'), this.$t('components.Crontab.index.464657-4'), this.$t('components.Crontab.index.464657-5'), this.$t('components.Crontab.index.464657-6')],
      tabActive: 0,
      myindex: 0,
      crontabValueObj: {
        second: "*",
